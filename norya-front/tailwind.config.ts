  ...
  theme: {
    extend: {
      colors: {
        ...
        // Paleta de acentos por página — ver globals.css (:root / html.light).
        pal: {
          cyan: 'var(--pal-cyan)',
          'cyan-line': 'var(--pal-cyan-line)',
          'cyan-soft': 'var(--pal-cyan-soft)',
          sky: 'var(--pal-sky)',
          'sky-ink': 'var(--pal-sky-ink)',
          'sky-line': 'var(--pal-sky-line)',
          'sky-soft': 'var(--pal-sky-soft)',
          peri: 'var(--pal-peri)',
          'peri-line': 'var(--pal-peri-line)',
          'peri-soft': 'var(--pal-peri-soft)',
          orchid: 'var(--pal-orchid)',
          'orchid-line': 'var(--pal-orchid-line)',
          'orchid-soft': 'var(--pal-orchid-soft)',
          pink: 'var(--pal-pink)',
          'pink-line': 'var(--pal-pink-line)',
          'pink-soft': 'var(--pal-pink-soft)',
          amber: 'var(--pal-amber)',
          'amber-line': 'var(--pal-amber-line)',
          'amber-soft': 'var(--pal-amber-soft)',
          green: 'var(--pal-green)',
          'green-line': 'var(--pal-green-line)',
          'green-soft': 'var(--pal-green-soft)',
          mint: 'var(--pal-mint)',
          'mint-line': 'var(--pal-mint-line)',
          'mint-soft': 'var(--pal-mint-soft)',
        },
        positive: '#6ee7b7',
        negative: '#f87171',
        warn:     '#fbbf24',
